...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 18 déc. 2019 à 17:02
...
(20191112204643, 'Initial', '2019-11-13 01:46:45', '2019-11-13 01:46:45', 0);
...
INSERT INTO `sales` (`id`, `category_id`, `subcategory_id`, `price`) VALUES
(1, 1, 1, 600);
...
ALTER TABLE `sales`
  ...
  ADD CONSTRAINT `sales_ibfk_2` FOREIGN KEY (`subcategory_id`) REFERENCES `subcategories` (`id`);
